...
var facebook = {
    ...
    getScholarships: function () {
        return {
            speech: '',
            displayText: "These are the list of scholarships available for you",
            data: {
                "facebook": {
                    "attachment": {
                        "type": "template",
                        "payload": {
                            ...
                            "elements": [
                                {
                                    "title": "Bruce Hobbs Scholarship",
                                    "image_url": "https://cdn3.iconfinder.com/data/icons/phones-set-2/512/27-512.png",
                                    "subtitle": "Duration : 1 Year<br> Amount : $6000 <br> Closing Date : 30, Nov, 2018",
                                    "buttons": [
                                        {
                                            "type": "postback",
                                            "title": "Apply Now",
                                            "payload": "apply for-Bruce Hobbs"
                                        },
                                        {
                                            "type": "web_url",
                                            "title": "New Device",
